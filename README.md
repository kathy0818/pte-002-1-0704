...
├─ PTE模考43B_听力_整理卷.pdf     ★ 听力，已完成（15 题，13 页）
├─ PTE模考43B_口语_整理卷.pdf     ★ 口语，仅收录 DI 看图说话 5 题（5 页，含配图）
├─ PTE模考43B_总整理卷.pdf         ★ 合订本：听·读·说(DI)，31 页
├─ 阅读/ 听力/ 口语/               各 part 的版本存档（听力 000/001…、阅读/口语 000…）
└─ 总整理卷/                       合订本源文件（.tex + img/）
```

> **本次范围**：只做了**阅读**与**听力**全部 15 题，口语只收录 **DI 看图说话 5 题**（RA/RS/RTS/ASQ 等口语其它题型、写作均未收录）。
> **进度：✅ 阅读（000）、✅ 听力（001，已补 SST 录音原文）、✅ 口语 DI（000）、✅ 合订本 全部完成。**

### ⚠️ 已知缺口 / Known gaps

| 部分 | 缺什么 | 已知信息 | 状态 |
|------|--------|---------|------|
| 阅读 R01（FIB #1076）| 第 3–5 空的四选项列表（干扰项）被平台悬浮条挡住 | 正确答案已知：has shed / commitment / urgency | **仍待补**——已在整理卷中标注（另一裁图分支只加了提示条，未提供实际缺失文字），需从平台"查看原题"手动复制干扰项文字 |
| 阅读 R14（MCS-R #45）| 选项 A 文字被平台悬浮条挡住 | 正确答案已知：A | **仍待补**，同上，需手动复制选项 A 原文 |
| ~~听力 Q1（SST #712）录音原文~~ | ~~缺录音原文文字稿~~ | | ✅ **已补全**（听力 001 版本，用户从平台"查看原题"截图提供） |
